...
class DefaultArchiveTestCase(unittest.TestCase):
    ...
    def test_is_archive_file(self):
        ...
        self.assertTrue(DefaultArchive.is_archive_file('file.zip'))
        self.assertTrue(DefaultArchive.is_archive_file('file.gzip'))
        self.assertTrue(DefaultArchive.is_archive_file('file.tar'))
